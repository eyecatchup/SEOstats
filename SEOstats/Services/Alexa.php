...
class Alexa extends SEOstats
{
    ...
    public static function getBacklinkCount($url = false)
    {
        ...
        return ! $nodes->item(0) ? parent::noDataDefaultValue() : self::retInt($nodes->item(0)->nodeValue);
    }
    ...
    public static function getPageLoadTime($url = false)
    {
        ...
        return ! $nodes->item(0) ? parent::noDataDefaultValue() : strip_tags($nodes->item(0)->nodeValue);
    }
