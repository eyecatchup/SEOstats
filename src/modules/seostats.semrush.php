<?php
	 ...
	 *
	 *  NOTE:       You may not perform more than 10 requests per second, 
	 *              nor more than 2 simultaneous requests!
	 *  Data TOS 	semrush.com/api.html#api6
     *
     *  @changelog
...
class SEOstats_SEMRush extends SEOstats 
{
	...
	public function getDomainRank($url = false, $db = 'us')
	{
		...
		if (!is_array($data)) {
			$data = self::getApiData( str_replace('.backend.','.api.',$semrushUrl) );
			if (!is_array($data)) {
				return false; }
		}
		return $data['rank'];
